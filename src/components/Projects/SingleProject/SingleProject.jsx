                            ...
                            <div style={{ width:"80%",display:"flex",flexFlow:"row",justifyContent:"space-evenly" }}>
                                ...
                                {logos.map((logo, id) => (
                                    ...
                                    <div  style={{width:"100%",alignItems: "center",textAlign: "center"}}key={id}>
                                        <i class={logo}></i>
                                        <p style={{ fontSize: "16px" }}>{logo === "fab fa-html5" ? "html" : logo === "fab fa-react" ? "rn" : logo === "fas fa-database" ? "Mongo" : logo === "fab fa-js" ? "js" : logo === "fab fa-vuejs" ? "EJS" : logo === "fab fa-vuejs" ? "EJS" : logo === "fab fa-css3" ? "CSS" : logo === "fab fa-node" ? "Node.js" : logo === "fab fa-bootstrap" ? "Bootstrap" :  logo === "fab fa-etsy" ? "Express" : logo === "fas fa-code" ? "ts" :""}</p>
                                    </div>
                             ))}
